...
const imageColors = {
    rose: '../images/Cadeau2.webp',
    rouge: '../images/Cadeau2-rouge.webp',
    noir: '../images/Cadeau2-noir.webp',
    bleu: '../images/Cadeau2-blue.webp'
};
...
colorButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        if (imageColors[color]) {
            imageCadeau.src = imageColors[color];
        }
        
        // Vérifier si une sélection est complète
        checkIfSelected();
    });
});
